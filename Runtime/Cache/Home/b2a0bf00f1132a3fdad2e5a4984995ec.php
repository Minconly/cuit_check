      ...
      <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
          <table class="site-table table-hover">
            ...
            <tbody>
              <?php if(is_array($classlst)): $i = 0; $__LIST__ = $classlst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
...
<script type="text/javascript">
  var editurl = "<?php echo U('Home/classMgr/editClass');?>";
  var listurl = "<?php echo U('Home/classMgr/classList');?>";
  var deleteurl = "<?php echo U('Home/classMgr/deleteclass');?>"
  var rooturl = "/";
...
layui.use(['layer','form','jquery','laypage','laydate'],function(){
 ...
 form.render('select');
  ...
  $('#searchAll').on('click', function(){
    ...
    window.location.href="<?php echo U('Home/classMgr/classList');?>";
  });
