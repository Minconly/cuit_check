...
<div class="admin-main">
    <div class="layui-field-box" style="padding: 0;">
        <blockquote class="layui-elem-quote layui-quote-nm" style="padding: 10px;">
            ...
            试卷名称：<span style="margin-left: 5px;font-size: 1.2em;font-weight: bold;"><?php echo ($data["paperName"]); ?></span></blockquote>
    </div>
...
<script>
    var rooturl = "";
    var listurl = "<?php echo U('Home/ScoreAnalysis/findTheData');?>";
    ...
    var exporturl = "<?php echo U('Home/ScoreAnalysis/exportSearchScore');?>";
    var paperKnowledgeUrl = "<?php echo U('Home/ScoreAnalysis/paperKnowledge');?>";
    var returnUrl = "<?php echo U('Home/ScoreAnalysis/scoreSearch');?>";
