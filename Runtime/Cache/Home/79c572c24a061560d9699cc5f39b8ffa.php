        ...
        <div class="layui-field-box">
            <table class="site-table table-hover">
                ...
                <?php if(!empty($paperList)): if(is_array($paperList)): $k = 0; $__LIST__ = $paperList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pl): $mod = ($k % 2 );++$k;?><tr>
                        ...
                        <td><?php echo ($pl["create_by"]); ?></td>
                        <td><?php echo ($pl["create_date"]); ?></td>
                        <td><a href="javascript:;" data-id="<?php echo ($pl["id"]); ?>" class="layui-btn layui-btn-mini detail">查看详情</a></td>
...
<script>
    var rooturl = "/";
    var listurl = "<?php echo U('Home/ScoreAnalysis/testRecordList');?>";
    var keyword = "<?php echo ($keyword); ?>";
    var pages = "<?php echo ($pages); ?>";
    var curr = "<?php echo ($requestPage); ?>";
    var college_id = "<?php echo ($college_id); ?>";
    var type_id = "<?php echo ($type_id); ?>";
    var detailurl = "<?php echo U('Home/ScoreAnalysis/detailPaper');?>";
</script>
<script type="text/javascript" src="/Public/static/js/testRecord.js"></script>
</body>
</html>